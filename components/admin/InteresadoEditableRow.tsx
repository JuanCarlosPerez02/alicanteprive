...
export default function InteresadoEditableRow({ interes: i, locale, fromParam }: Props) {
  ...
  return (
    <>
      ...
      >
        ...
        <td className="px-4 py-3 capitalize text-muted-foreground text-sm">{i.origen}</td>
        <td className="px-4 py-3">
            ...
            <div className="flex gap-3 items-end max-w-2xl">
              <div className="flex-1">
                ...
                <textarea
                  ...
                  placeholder="Notas sobre este interesado…"
                />
              </div>
      ...
      <ConfirmDialog
        ...
        title={`¿Eliminar a ${i.contacto?.nombre ?? 'este contacto'} como interesado?`}
